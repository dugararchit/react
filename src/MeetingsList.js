...
class MeetingsList extends Component {
    ...
    deleteMeeting(e, meetingID) {
        ...
        var deletingConfirmation = window.confirm("Are you sure, you want to delete..?");
        if (deletingConfirmation) {
            let ref = firebase.database().ref(`meetings/${this.props.userId}/${meetingID}`);
            ref.remove()
        }
